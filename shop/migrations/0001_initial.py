# Generated by Django 3.2rc1 on 2022-01-25 06:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.IntegerField(help_text='В процентах', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(100)])),
            ],
            options={
                'verbose_name': 'Скидка',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sections', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='shop.section', verbose_name='Раздел')),
            ],
            options={
                'verbose_name': 'Товар',
